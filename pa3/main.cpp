...
int main()
{
	...
	DecimalNode* a3 = createNumber("0100", "010");
	printNumber(a3);
	printNumberReversed(a3);
	DecimalNode* a4 = createNumber("000", "10");
	printNumber(a4);
	printNumberReversed(a4);
	DecimalNode* a5 = createNumber("000123000", "00045600");
	printNumber(a5);
	printNumberReversed(a5);
	DecimalNode* a6 = createNumber("abc1a23abc", "123");
	if (a6 == NULL) {
		cout << "A6 testing is NULL. " << endl;
	}
	DecimalNode* a7 = createNumber("123", "");
	if (a7 == NULL) {
		cout << "A7 testing is NULL. " << endl;
	}
	...
	cout << "Test " << 6 << ": " << (search(nHead, 'a') == NULL ? "passed" : "failed") << endl;

	cout << endl << "Testing getIntegerPartLength..." << endl;
	cout << getIntegerPartLength(a5);
	cout << endl;

	cout << endl << "Testing getFractionalPartLength..." << endl;
	cout << getFractionalPartLength(a5);
	cout << endl;

	cout << endl << "Testing compare..." << endl;
	DecimalNode* b1 = createNumber("00", "0123");
	printNumber(b1);
	printNumberReversed(b1);
	DecimalNode* b2 = createNumber("1123", "123");
	printNumber(b2);
	printNumberReversed(b2);
	DecimalNode* b3 = createNumber("123", "1231");
	printNumber(b3);
	printNumberReversed(b3);
	DecimalNode* b4 = createNumber("0", "1");
	printNumber(b4);
	printNumberReversed(b4);
	...
	cout << "b4 vs b1" << endl;
	cout << compare(b4, b1) << endl;
	cout << compare (b1, b4) << endl;
    ...
    divide(b1, 4);
    printNumber(b1);
    printNumberReversed(b1);	 cout << "b1 /= 10:" << endl;
    divide(b1, 1);
    printNumber(b1);
    printNumberReversed(b1);
    cout << "b1 /= 10:" << endl;
